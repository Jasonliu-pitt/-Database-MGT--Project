...
router.get('/findbyuser/', function(req, res, next) {
  Cart.find({"uId":req.query.uId,"uType":req.query.uType},function(error,carts){
		if(carts){
			res.json(carts);
		}else{
...
router.post('/addtocart', function(req, res, next) {
	Cart.findOne({"uId":req.body.uId,"uType":req.body.uType, "cId":req.body.cId},function(error,doc){
		if(doc){
